...
const studentCodingRoutes = require('./routes/student/coding.routes');
const facultyRoutes = require('./routes/faculty/faculty.routes');
const hodRoutes = require('./routes/hod/hod.routes');
const hodCodingRoutes = require('./routes/hod/coding.routes');
const adminRoutes = require('./routes/admin/admin.routes');
const adminDiscoveryRoutes = require('./routes/admin/discovery.routes');
...
app.use('/api/student', studentCodingRoutes);
app.use('/api/faculty', facultyRoutes);
app.use('/api/hod', hodRoutes);
app.use('/api/hod', hodCodingRoutes);
app.use('/api/admin', adminLimiter, adminRoutes);
app.use('/api/admin', adminDiscoveryRoutes);
app.use('/api/admin', adminCodingRoutes);
