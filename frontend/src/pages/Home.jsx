...
const Home = () => {
    return (
        <div className="w-screen min-h-screen bg-gray-50 dark:bg-[#030712] text-gray-900 dark:text-white overflow-x-hidden selection:bg-indigo-500 selection:text-white font-sans transition-colors duration-300">
            ...
            {/* Main Hero Section - Unified Container */}
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between h-screen w-screen">
                ...
                <motion.div
                    ...
                    className="text-center lg:text-left px-8 lg:px-16"
                >
                    <motion.div
