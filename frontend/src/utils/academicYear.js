 ...
 */
export const getAcademicYearDiff = (admissionYear) => {
 ...
 */
export const getAcademicYearLabel = (admissionYear) => {
    if (!admissionYear) return 'Unknown';
    
    const diff = getAcademicYearDiff(admissionYear);
